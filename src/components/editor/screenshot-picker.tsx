...
export function ScreenshotPicker({ label, value, locale, orientation, onChange }: Props) {
  ...
  const resolvedValue =
    hasValue && !isData && locale ? resolveScreenshot(value, locale, orientation) : value;
